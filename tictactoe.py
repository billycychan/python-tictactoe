...
def check_winner():
    ...
    for column in range(3):
        if buttons[0][column]['text'] == buttons[1][column]['text'] == buttons[2][column]['text'] != "":
            buttons[0][column].config(highlightbackground="green")
            buttons[1][column].config(highlightbackground="green")
            buttons[2][column].config(highlightbackground="green")
            return True
    ...
    if buttons[0][0]['text'] == buttons[1][1]['text'] == buttons[2][2]['text'] != "":
        ...
        for row in range(3):
            for column in range(3):
                buttons[row][column].config(highlightbackground="yellow")
        return "Tie"
